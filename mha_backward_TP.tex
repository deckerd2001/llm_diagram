...
\node[auxnode] (T_WK_bwd) [below=0.5cm of dKX_proj_calc] {T};
\node[dimlabel] (WK_bwd) [below=0.5cm of T_WK_bwd] {$\widetilde{\mathbf{W}}_{K}^{(i)}$\\$[D,N_{HN}D_h]$};
...
\node[mulnode] (dWK_mul) at ($(dK_branch)+(0,-3.1cm)$) {$\bullet$};
